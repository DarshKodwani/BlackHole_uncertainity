...
Our surprising result is that in the black hole case, we get an infinitely larger effects than in Minkowski space, which is difficult to blame on the usual divergence of QFT.
\end{itemize}
