...
Since $\delta t_2$ is equal to the time interval observed by the observer at $r_0$, $\delta t_0$, we can find the proper time observed by the observer, $\delta \tau_0$,

\begin{equation}
	\delta \tau_0  = \delta t_e \left( \left( \frac{r_2 - 2M}{r_1 - 2M} \right) \left( \frac{r_1 - 2(M-\Delta M)}{r_2 - 2(M - \Delta M)} \right) \left( 1 -\frac{2M}{r_0} \right) \right)^\frac{1}{2}. 
\end{equation}
...
\begin{figure}[h!]
\begin{center}.
\includegraphics[scale = 0.5]{tau_compare.pdf}
\caption{}
\label{}
\end{center}
\end{figure}
