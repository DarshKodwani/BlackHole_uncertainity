...
For large black holes, it manifests itself as unitary propagation of every near-horizon mode into every asymptotic Hawking quanta. The back-reaction of such effect is no more than a Schwarzschild metric with a very slowly changing mass.
\end{itemize}
...
The fundamental principle behind Feynman's trick is that ``classical wave coherence'', in his case the observability of the interference pattern, should be taken as the prerequisite of ``quantum unitarity''. 
