...
\section{Calculation of proper time change}\label{Dtime}
...
\begin{eqnarray}
	\frac{\delta t_0 - \bar{\delta t_0}}{\delta t_0} & = & \left( \left( 1+ \frac{\Delta r}{r_1 - 2M} \right)^\frac{1}{2} \left( 1 + \frac{2\Delta M}{r_1 - 2M} \right)^\frac{1}{2} \left( 1 + \frac{\Delta r + 2 \Delta M}{r_1 - 2M} \right)^{-\frac{1}{2}} - 1	\nonumber	\\
	...
	& = & - \frac{1}{8} \left( \frac{\Delta r}{r_1 - 2M} \right)^2 + \frac{1}{2} \frac{\Delta r \Delta M}{(r_1 - 2M)^2} - \frac{1}{2} \left( \frac{\Delta M}{r_1 - 2M} \right)^2 - \frac{1}{4} \frac{( \Delta r + 2 \Delta M)^2}{(r_1 - 2M)^2} + \frac{3}{8} \frac{(\Delta r+ 2 \Delta M)^2}{(r_1 - 2M)^2} 	\nonumber	\\
...
\begin{eqnarray}
	...
	& = & 4 \pi \sigma \dDelta l \left( 1 + \frac{2M}{l} \right) + \mathcal{O}(l^{-2})
\end{eqnarray}
