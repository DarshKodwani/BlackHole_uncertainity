...
{\it If we do not see an interference pattern because the quantum uncertainty of the double-slit position is too large and it makes the pattern blurry, then the evolution for the particle alone is not unitarity, because it becomes entangled with the double-slit.}
...
Thus, within a classical theory, even if we do not see an interference pattern, we can never know whether $\Delta y^{\rm ds}$ is the true reason that erases the interference pattern.
